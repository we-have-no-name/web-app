...
def main():
	...
	max_tweets=[5000] #use -1 for an unlimited stream
	def stream_task(q):
...
##	txt = 'tweet: {}\nprobs: {}\ncountry: {}\nlocation: {}\nlang: {}\n'.format(tweet.text, probs, tweet.country, tweet.location, tweet.lang)
##	txt.translate(non_bmp_map)
	txt = tweet.sentiment
##	txt.encode(sys.stdout.encoding, errors='replace')
	print(txt)
